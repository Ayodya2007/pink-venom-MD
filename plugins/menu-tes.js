...
${global.cmenua}
  `
await conn.sendButton(m.chat, cap, '© 𝘾𝙧𝙚𝙖𝙩𝙚𝙙 𝘽𝙮 𝐒𝐤𝐲𝐁𝗼𝐭 𝐌𝐝', Buffer.alloc(0), [['List Menu', '.tesm'], ['All Menu', '/allmenu']], fkontak, { mimetype: "text/rtf", fileName: '𝑺𝒊𝒎𝒑𝒍𝒆 𝑩𝒐𝒕 𝑾𝒉𝒂𝒕𝒔𝑨𝒑𝒑 𝑩𝒚 𝑨𝒓𝒊𝒇𝒛𝒚𝒏', pageCount: 90000, fileLength: 90000, seconds: 90000, jpegThumbnail: pepe, 
			contextInfo: {
